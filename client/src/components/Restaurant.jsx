                ...
                >
                    ...
                    <div style={{ textAlign: 'left', marginTop: '50px' }}>
                        <h1 style={{ fontFamily: 'esti' }}>
                            Häagen-Dazs Direct - SoMa - 475 6th St Menu Info
                        </h1>
                        <div style={{ color: '#0070eb', marginTop: '10px' }}>
                            Ice Cream
                        </div>
                        <div style={{ marginTop: '10px' }}>$$$$$</div>
                        <div style={{ fontSize: '17px', marginTop: '10px' }}>
                            At Häagen-Dazs® Shops we are proud to serve only the
                            highest quality ice cream made with no artificial
                            colors, flavors or preservatives. Since the very
                            first Shop opened in 1976, we have never wavered in
                            our commitment to using only the finest ingredients
                            to deliver extraordinary (and irresistible)
                        </div>
                        <div
                            style={{
                                display: 'flex',
                        ...
                        >
                            <div>
                                ...
                                <div
                                    style={{ border: '0.5px solid #e2dff1' }}
                                ></div>
                                <div
                                    style={{
                                        color: '#0070eb',
                                ...
                                >
                                    View more about Häagen-Dazs Direct - SoMa -
                                    475 6th St
                                </div>
                                <div
                                    style={{ border: '0.5px solid #e2dff1' }}
                    ...
                    <div style={{ marginTop: '35px', textAlign: 'left' }}>
                        <div style={{ marginTop: '35px' }}>
                            ...
                            <div style={{ marginTop: '20px' }}>
                                <h4 className={styles.esti}>
                                    Q) Does Häagen-Dazs Direct - SoMa - 475 6th
                                    St (475 6th St) deliver?
                                </h4>
                                <div
                                    style={{
                                        fontSize: '15px',
                                ...
                                >
                                    A) Yes, Häagen-Dazs Direct - SoMa - 475 6th
                                    St (475 6th St) delivery is available on
                                    Grubhub.
                                </div>
                            </div>
                            <div style={{ marginTop: '20px' }}>
                                <h4 className={styles.esti}>
                                    Q) Does Häagen-Dazs Direct - SoMa - 475 6th
                                    St (475 6th St) offer contact-free delivery?
                                </h4>
                                <div
                                    style={{
                                        fontSize: '15px',
                                ...
                                >
                                    A) Yes, Häagen-Dazs Direct - SoMa - 475 6th
                                    St (475 6th St) provides contact-free
                                    delivery with Grubhub.
                                </div>
                            </div>
                            <div style={{ marginTop: '20px' }}>
                                <h4 className={styles.esti}>
                                    Q) Is Häagen-Dazs Direct - SoMa - 475 6th St
                                    (475 6th St) eligible for Grubhub+ free
                                    delivery?
                                </h4>
                                <div
                                    style={{
                                ...
                                >
                                    A) Yes, Grubhub offers free delivery for
                                    Häagen-Dazs Direct - SoMa - 475 6th St (475
                                    6th St) with a Grubhub+ membership.
                                </div>
                            </div>
                        </div>
                    </div>
